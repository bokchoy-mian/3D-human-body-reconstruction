...
# from  normal2depth import mask2tiny
...
def Depth2VerTri(depth, mask):
  ...
  #       continue
  #
  #     index_map[i, j] = index_depth
  #     index_depth += 1
  #
  #
  #     vertex_depth.append( [j, -i, depth[i, j]] )
...
if __name__ == '__main__':
  mask = mask2tiny ('smpl_mask.png', 1)
  # depth=cv2.imread('smpl_depth.png',cv2.IMREAD_GRAYSCALE)
  depth=np.load('depth_nomal.npy')
  vertex, triangle = Depth2VerTri (depth, mask)
  writeobj ('smpl_recovered13.obj', vertex, triangle)