...
from lib.Gen_SMPLH.mesh_viewer import MeshViewer
from lib.Gen_SMPLH import util
    ...
    def run_fitting(self, optimizer, closure, params, body_model,
        ...
        for n in range(self.maxiters):
            ...
            if n > 0 and prev_loss is not None and self.ftol > 0:
                loss_rel_change = util.rel_change(prev_loss, loss.item())
...
class SMPLifyLoss(nn.Module):
    ...
    def __init__(self, search_tree=None,
        ...
        self.robustifier = util.GMoF(rho=rho)
        self.rho = rho
    ...
    def __init__(self, init_joints_idxs, trans_estimation=None,
        ...
        if trans_estimation is not None:
            self.register_buffer(
                'trans_estimation',
                util.to_tensor(trans_estimation, dtype=dtype))
        else:
        ...
        self.register_buffer(
            'init_joints_idxs',
            util.to_tensor(init_joints_idxs, dtype=torch.long))
