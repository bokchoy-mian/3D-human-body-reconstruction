...
def parse_config(argv=None):
    ...
    parser = configargparse.ArgParser(formatter_class=arg_formatter,
                                      ...
                                      prog='SMPLifyX')
    parser.add_argument ('--input_img_path',default='../data/input',type=str)
    parser.add_argument ('--input_keyp_path',default='../data/input',type=str)
    parser.add_argument ('--output_folder',default='../data/output',type=str)

    parser.add_argument ('-c', '--config',default='./Gen_SMPLH/fit_smplh.yaml', is_config_file=True,
                         help='config file path')
    parser.add_argument ('--vposer_ckpt', type=str, default='./vposer',
                         help='The path to the V-Poser checkpoint')
    parser.add_argument ('--visualize',type=lambda arg: arg.lower () == 'true',
                         default=False,
                         help='Display plots while running the optimization')
    parser.add_argument('--prior_folder', type=str, default='./data_files/prior',
    ...
    parser.add_argument ('--part_segm_fn', default='Gen_SMPLH/smplx_parts_segm.pkl', type=str,
    ...
    parser.add_argument('--model_type', default='smplh', type=str,
